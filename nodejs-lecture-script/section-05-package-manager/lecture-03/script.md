# 05 package manager - Lecture 03

## 강의 목표
1. 버전 관리(semver)의 핵심 흐름을 이해한다.
2. 강의 중 버전 관리(semver) 실습를 직접 수행한다.
3. 다음 강의로 연결되는 실무 포인트를 정리한다.

## 강의 진행 스크립트

### 1) 오프닝
- "이번 차시는 Lecture 03입니다. 목표는 버전 관리(semver)입니다."
