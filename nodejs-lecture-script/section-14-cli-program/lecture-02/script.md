# 14 cli program - Lecture 02

## 강의 목표
1. 배포 가능한 CLI 패키징의 핵심 흐름을 이해한다.
2. 강의 중 배포 가능한 CLI 패키징 실습를 직접 수행한다.
3. 다음 강의로 연결되는 실무 포인트를 정리한다.

## 강의 진행 스크립트

### 1) 오프닝
- "이번 차시는 Lecture 02입니다. 목표는 배포 가능한 CLI 패키징입니다."
- "실습 중심으로 진행하고, 마지막에 바로 적용 과제를 드리겠습니다."

### 2) 핵심 설명
- 문제 상황 정의
- 배포 가능한 CLI 패키징 개념 구조
- 자주 발생하는 실수와 예방법

### 3) 실습
- 실습 항목: 배포 가능한 CLI 패키징 실습
- 실습 완료 기준
  - 기능 동작 확인
  - 오류 케이스 1개 재현 및 해결
