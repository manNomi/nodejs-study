# 16 aws serverless s3 lambda - Lecture 02

## 강의 목표
1. Lambda 이벤트 처리의 핵심 흐름을 이해한다.
2. 강의 중 Lambda 이벤트 처리 실습를 직접 수행한다.
3. 다음 강의로 연결되는 실무 포인트를 정리한다.

## 강의 진행 스크립트

### 1) 오프닝
- "이번 차시는 Lecture 02입니다. 목표는 Lambda 이벤트 처리입니다."
